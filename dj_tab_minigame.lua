-- dj_tab_minigame.lua
-- Minigame tab for DJ HUB | The Forge
-- Rayfield-docs-compliant
...
return function(Window, Rayfield, Utils)
    ...
    -- FIX: Notify entfernt — war Ursache des Tab-Switches
    -- ================================================================
    ...
    local function handleMutationFilter()
        ...
        -- Notify ist OK hier — einmalig pro Skip
        Rayfield:Notify({
    ...
    -- ================================================================
    -- UI — AUTO CLICK BONUS
    -- Mobile FIX: TouchTap statt SendMouseButtonEvent
    -- ================================================================
    ...
    local function runBonusClicker()
        ...
        while bonusEnabled do
            for _, obj in ipairs(KickUpgrades:GetChildren()) do
                ...
                if obj:IsA("ImageButton") and obj.Name == "Bonus" and obj.Visible then
                    pcall(function()
                        local pos = obj.AbsolutePosition + obj.AbsoluteSize / 2
                        if isMobile then
                            -- Mobile/iPad: Touch events simulieren
                            vim:SendTouchEvent(pos.X, pos.Y, Enum.UserInputType.Touch, true, game)
                            task.wait(0.05)
                            vim:SendTouchEvent(pos.X, pos.Y, Enum.UserInputType.Touch, false, game)
                        else
                            -- PC: Mouse events
